...
//    Serial.print(local_time);Serial.print(";");Serial.print(diff_time);Serial.print(";");
    ...
    Serial.print(measurement_acceleration);Serial.print(";");  
...
float servo_speed_step() {
  ...
  if (speed_feedback() < goal_speed) {
      ...
      else if (speed_feedback() < goal_speed * 0.96) {
        servo_step = 0.07;
      }
      else if (speed_feedback() < goal_speed * 0.97) {
        servo_step = 0.05;
      }
      else if (speed_feedback() < goal_speed * 0.98) {
        servo_step = 0.03;
      }
      else if (speed_feedback() < goal_speed * 0.99) {
        servo_step = 0.02;
      }
      else
        servo_step = 0.01;
      ...
      else if (speed_feedback() > goal_speed * 1.04) {
        servo_step = -0.07;
      }
      else if (speed_feedback() > goal_speed * 1.03) {
        servo_step = -0.05;
      }
      else if (speed_feedback() > goal_speed * 1.02) {
        servo_step = -0.03;
      }
