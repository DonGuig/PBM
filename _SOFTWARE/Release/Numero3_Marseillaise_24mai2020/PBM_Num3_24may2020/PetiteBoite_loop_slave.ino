...
#ifdef DEBUG
      debugI("Master requested STOP, will stop at NEXT microswitch");
#endif
...
#ifdef DEBUG
      debugI("Sending READY_TO_BEGIN to master");
#endif
...
#ifdef DEBUG
      debugI("Received_order_to_begin");
#endif
    slave_begin = true;
  }
}
